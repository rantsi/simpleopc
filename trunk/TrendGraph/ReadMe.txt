========================================================================
    ACTIVEX CONTROL DLL : TrendGraph Project Overview
========================================================================

ControlWizard has created this project for your TrendGraph ActiveX Control
...
that make up your TrendGraph ActiveX Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
CTrendGraphCtrl control:

TrendGraphCtrl.h
    This file contains the declaration of the CTrendGraphCtrl C++ class.

TrendGraphCtrl.cpp
    This file contains the implementation of the CTrendGraphCtrl C++ class.

TrendGraphPropPage.h
    This file contains the declaration of the CTrendGraphPropPage C++ class.

TrendGraphPropPage.cpp
    This file contains the implementation of the CTrendGraphPropPage C++ class.

CTrendGraphCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CTrendGraphCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file TrendGraph.rc.
...
stdafx.h, stdafx.cpp
    ...
    named TrendGraph.pch and a precompiled types (PCT) file named stdafx.obj.
